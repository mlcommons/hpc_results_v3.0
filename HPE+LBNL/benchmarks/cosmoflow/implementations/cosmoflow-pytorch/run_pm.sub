#!/bin/bash
#SBATCH -J cosmoflow-opt
#SBATCH -A m4291
#SBATCH -C gpu
#SBATCH -q regular
#SBATCH --gpus-per-node 4
#SBATCH --cpus-per-task 32
#SBATCH --image registry.nersc.gov/das/cosmoflow-opt:23.09.00
...
# Launch time-to-train (single-instance) jobs
