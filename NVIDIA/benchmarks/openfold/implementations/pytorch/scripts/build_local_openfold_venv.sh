...
git clone https://github.com/NVIDIA/apex.git $PREFIX_PATH/apex \
&& pip install --disable-pip-version-check --no-build-isolation --no-cache-dir --editable $PREFIX_PATH/apex
