...
def mnist_model(image, labels, mesh):
  ...
  row_blocks_dim = mtf.Dimension("row_blocks", 2)
  col_blocks_dim = mtf.Dimension("col_blocks", 2)
  rows_dim = mtf.Dimension("rows_size", 14)
  cols_dim = mtf.Dimension("cols_size", 14)

  classes_dim = mtf.Dimension("classes", 10)
  one_channel_dim = mtf.Dimension("one_channel", 1)

  x = mtf.import_tf_tensor(
      mesh, tf.reshape(image, [FLAGS.batch_size, 2, 14, 2, 14, 1]),
      mtf.Shape(
