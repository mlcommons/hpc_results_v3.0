...
#define OPAL_BUILD_PLATFORM_COMPILER_FAMILYID 0

/* The compiler version which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION 0
...
#define OMPI_HAVE_FORTRAN_REAL2 1
...
#  else
#    if OPAL_C_HAVE_VISIBILITY == 1 && __GNUC__ /* 20100511 updated by shidax for fccpx */
